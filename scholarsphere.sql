...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2024 at 05:04 PM
...
INSERT INTO `bookchaptersbyfaculty` (`srNo`, `University`, `Department`, `Faculty`, `Employee ID`, `other Author`, `Type`, `Co-author`, `booktitle`, `region`, `pubdate`, `pubyear`, `volume`, `pagefrom`, `pageto`, `scopus`, `listedin`, `wos`, `peer`, `issnisbn`, `pubname`, `affltn`, `corrauthor`, `citind`, `nocit`, `evdupload`, `othrinfo`, `ref`, `status`) VALUES
(3, 'Amity University', 'Btech', 'shilpa', 12, 'shilpa', '', 'Selena', 'Machine Learning', 'International', '2024-09-10', '1986', '34', 56, 34, 'y', 'UGC', 'y', 'n', '11', 'jk rowling', 'ICSE', 'Jane', 9, 3, 'uploads/Screenshot (19).png', '', '', 1),
(7, 'Amity University', 'Btech', 'shilpa', 12, 'shilpa', '', 'Jane Austin', 'ML', 'International', '2024-09-09', '2019', '5', 21, 12, 'y', 'PubMed', 'n', 'n', '13', 'jk rowling', 'ICSE', 'Jane', 3, 1, '', '', '', 0);
...
INSERT INTO `booksbyfaculty` (`srNo`, `University`, `Department`, `Faculty`, `Employee ID`, `other Author`, `Type`, `Co-author`, `booktitle`, `region`, `pubdate`, `pubyear`, `volume`, `pagefrom`, `pageto`, `scopus`, `listedin`, `wos`, `peer`, `issnisbn`, `pubname`, `affltn`, `corrauthor`, `citind`, `nocit`, `evdupload`, `othrinfo`, `ref`, `status`) VALUES
(7, 'Amity University', 'Btech', 'shilpa', 12, 'shilpa', '', 'Jane Austin', 'Good girl guide to murder', 'National', '2024-09-21', '2019', '12', 12, 32, 'y', 'UGC', 'n', 'n', '90', 'jk rowling', 'ICSE', 'Jane', 1, 2, '', '', '', 1),
(8, 'Amity University', 'Btech', 'shilpa', 12, 'shilpa', 'Co-Author', 'Dhruv', 'bottle', 'National', '2024-11-01', '0000', '213', 12312, 123312, 'y', 'ICI', 'y', 'n', 'NA', 'Kaleen', 'Asus', 'Jane Austin', 123, 132, 'uploads/amity-logo.jpeg', '', '', 0);
...
(1, 'Amity University', 'Btech', 'shilpa', 12, 'shilpa', '', 'Jane Austin', 'Good girl guide to murder', 'framework', 'Fear Street', 'International', '2024-09-12', '1988', '12', 12, 31, '12', 'y', 'UGC', 'n', 'n', '13', 'jk rowling', 'ICSE', 'Jane', 34, 1, '', 'uploads/WhatsApp Image 2024-09-08 at 15.08.45.jpeg', '', '', 1),
(2, 'Amity University', 'Btech', 'shilpa', 12, 'shilpa', '', 'Austin Mahonae', 'ML', 'AI', 'Fear Street', 'International', '2024-09-19', '2009', '12', 34, 67, '1.3', 'y', 'PubMed', 'n', 'n', '12', 'jk rowling', 'ICSE', 'Jane', 5, 6, '', '', '', '', 0),
(44, 'Amity University', 'Btech', 'shilpa', 12, 'shilpa', '', 'Selena', 'ML', 'Artificial Intelligenece', 'Fear Street123', 'National', '2024-09-11', '0000', '67', 54, 89, '8.0', 'y', 'UGC', 'n', 'n', '90', 'jk rowling', 'ICSE', 'Jane', 7, 78, '', 'uploads/Screenshot (17).png', '', '', 1),
(46, 'Amity University', 'Btech', 'shilpa', 12, 'shilpa', '', 'Jane Austin', 'ML', 'AI', 'Fear Street', 'National', '2024-09-19', '2019', '5', 12, 32, '1.3', 'y', 'UGC', 'n', 'n', '13', 'jk rowling', 'ICSE', 'Jane', 9, 2, 'https://docs.google.com/document/d/1GPT5ag88xuTBGtSNtk_merjoRR0jzqGUfR9hnakG9ug/edit?usp=sharing', 'uploads/Screenshot (18).png', '', '', 1),
(47, 'Amity University', 'Btech', 'shilpa', 12, 'shilpa', '', 'Jane Austin', 'Good girl guide to murder', 'framework', 'Fear Street', 'International', '2024-09-12', '1988', '12', 12, 31, '12', 'y', 'UGC', 'n', 'n', '13', 'jk rowling', 'ICSE', 'Jane', 34, 1, '', '', '', '', 0),
(48, 'Amity University', 'Btech', 'shilpa', 12, 'shilpa', '', 'Jane Austin', 'ML', 'AI', 'Fear Street1', 'National', '2024-11-19', '2019', '1', 2, 3, '', 'y', 'PubMed', 'n', 'n', '23', 'jk rowling', 'ICSE', 'Jane', 0, 0, '', '', '', '', 0),
(52, 'Amity University', 'Btech', 'shilpa', 12, 'shilpa', 'First Author', 'Jane Austin', 'ML', 'AI', 'Fear Street', 'National', '2024-11-27', '2009', '2', 2, 3, '', 'y', 'PubMed', 'n', 'n', '3', 'jk rowling', 'ICSE', 'Jane', 0, 0, '', 'uploads/Screenshot (57).png', '', '', 0);
