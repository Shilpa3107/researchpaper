...
<div class="container  mx-auto p-6 max-w-7xl bg-white rounded-lg shadow-lg">
	...
	<form class="space-y-6" method="post" action="editReopapersAdmin.php" enctype="multipart/form-data">
		...
		<input type="hidden" name="university" value="<?php echo $row['University'] ?>">
			...
			<input type="hidden" name="firstAuthor" value="<?php echo $row['Type']; ?>">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<div class="mb-4">
					...
					<input required type="text" name="edition" id="volume-edition" value="<?php echo $row['volume']; ?>" placeholder="Enter Volume/Issue" class="mt-1 w-full px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
				</div>
