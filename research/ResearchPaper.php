			...
			if($_SERVER['REQUEST_METHOD']=='POST') {
				...
				$AuthorType = isset($_POST['AuthorType']) ? $_POST['AuthorType'] : '';
    ...
    (`University`, `Department`, `Faculty`, `Employee ID`, `Author`, `AuthorType`,`Co-author`, `papertitle`, `journalname`, `article`, `region`, `pubdate`, `pubyear`, `volume`, `pagefrom`, `pageto`, `impact`, `scopus`, `listedin`, `wos`, `peer`, `issn`, `isbn`, `pubname`, `affltn`, `corrauthor`, `citind`, `nocit`, `link`, `evdupload`, `othrinfo`, `ref`) 
    VALUES ('$uni', '$department', '$faculty', '$empid', '$author','$AuthorType', '$coauthor', '$booktitle', '$journalname', '$article', '$National', '$publicationdate', '$pubyear', '$edition', '$pagefrom', '$pageto', '$impact', '$scopus', '$listedin', '$wos', '$peer', '$issn', '$isbn', '$pubname', '$affltn', '$corrauthor', '$citind', '$nocit', '$link', '$destination', '$othrinfo', '$ref')";
    ...
    <select required id="AuthorType" name="AuthorType" class="mt-1 w-full max-w-xs px-4 py-2 border rounded-md border-blue-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
		<option value="" disabled selected>Select Author Type</option>
		...
		<div id="section2" class="form-section">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
				...
				<div class="mb-4">
					...
					<input required type="text" name="edition" id="volume-edition" placeholder="Enter Volume/Issue" class="mt-1 w-full max-w-xs px-4 py-2 border rounded-md border-blue-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
				</div>
				...
				<div class="mb-4">
					...
					<input type="number" name="citind" id="citation-index" placeholder="Enter Citation Index" class="mt-1 w-full max-w-xs px-4 py-2 border rounded-md border-blue-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
				</div>
				...
				<div class="mb-4">
					...
					<input type="number" name="nocit" id="num-citations" placeholder="Enter Number of Citations" class="mt-1 w-full max-w-xs px-4 py-2 border rounded-md border-blue-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
				</div>
				<!-- Reference -->
				<div class="mb-4">
				...
				<div class="mb-4">
					...
					<input type="text" name="impact" id="impact-factor" placeholder="Enter Impact Factor" class="mt-1 w-full max-w-xs px-4 py-2 border rounded-md border-blue-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
				</div>
